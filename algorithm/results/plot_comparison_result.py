...
# 加载各个benchmark的报告和错误数据
for benchmark_name in dataset_names:
    benchmark_dir = os.path.join('.', 'evaluation', benchmark_name)  # 对应benchmark的文件夹路径
    ...
    for method_name in methods:
        report_path = os.path.join(benchmark_dir, f'{method_name}_summary_report.dat')
        error_path = os.path.join(benchmark_dir, f'{method_name}_summary_errors.dat')
