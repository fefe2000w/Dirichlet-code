...
for dataset in dataset_names:
    ...
    vi_time.append(
        all_report[dataset]["vi_elapsed_optim"]
        + all_report[dataset]["vi_elapsed_pred"]
    )
    db_time.append(
        all_report[dataset]["db_elapsed_optim"]
        + all_report[dataset]["db_elapsed_pred"]
    )
    la_time.append(
        all_report[dataset]["la_elapsed_optim"]
        + all_report[dataset]["la_elapsed_pred"]
    )
    ep_time.append(
        all_report[dataset]["ep_elapsed_optim"]
        + all_report[dataset]["ep_elapsed_pred"]
    )
